...
goog.exportSymbol('proto.compiler.BuildEndEvent', null, global);
...
goog.exportSymbol('proto.compiler.BuildStartEvent', null, global);
goog.exportSymbol('proto.compiler.BuildStatus', null, global);
 ...
 * @extends {jspb.Message}
 * @constructor
 */ proto.compiler.BuildStartEvent = function(opt_data) {
    jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.compiler.BuildStartEvent, jspb.Message);
if (goog.DEBUG && !COMPILED) {
    /**
   * @public
   * @override
   */ proto.compiler.BuildStartEvent.displayName = 'proto.compiler.BuildStartEvent';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @extends {jspb.Message}
 * @constructor
 */ proto.compiler.BuildEndEvent = function(opt_data) {
    jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.compiler.BuildEndEvent, jspb.Message);
if (goog.DEBUG && !COMPILED) {
    /**
   * @public
   * @override
   */ proto.compiler.BuildEndEvent.displayName = 'proto.compiler.BuildEndEvent';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */ proto.compiler.File.repeatedFields_ = [
    3
];
 ...
 * @private {!Array<number>}
 * @const
 */ proto.compiler.BuildRequest.repeatedFields_ = [
    3
];
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
 ...
 */ proto.compiler.BuildRequest.toObject = function(includeInstance, msg) {
        var f, obj = {
            ...
            filesList: jspb.Message.toObjectList(msg.getFilesList(), proto.compiler.File.toObject, includeInstance),
 ...
 */ proto.compiler.BuildRequest.serializeBinaryToWriter = function(message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.compiler.File.serializeBinaryToWriter);
    }
 ...
 */ proto.compiler.BuildRequest.prototype.getFilesList = function() {
    return /** @type{!Array<!proto.compiler.File>} */ jspb.Message.getRepeatedWrapperField(this, proto.compiler.File, 3);
};
/**
 ...
 * @private {!Array<number>}
 * @const
 */ proto.compiler.BuildResponse.repeatedFields_ = [
    1
];
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
    ...
    while(reader.nextField()){
        ...
        switch(field){
            case 1:
                ...
                break;
            case 2:
                var value = /** @type {!proto.compiler.BuildStatus} */ reader.readEnum();
                msg.setStatus(value);
                break;
            case 3:
                var value = /** @type {string} */ reader.readString();
 ...
 */ proto.compiler.BuildResponse.serializeBinaryToWriter = function(message, writer) {
    ...
    f = message.getFilesList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.compiler.File.serializeBinaryToWriter);
    }
    f = message.getStatus();
    if (f !== 0.0) {
 ...
 */ proto.compiler.BuildResponse.prototype.getFilesList = function() {
    return /** @type{!Array<!proto.compiler.File>} */ jspb.Message.getRepeatedWrapperField(this, proto.compiler.File, 1);
};
/**
 * @param {!Array<!proto.compiler.File>} value
 ...
 * @return {!proto.compiler.BuildStatus}
 */ proto.compiler.BuildResponse.prototype.getStatus = function() {
    return /** @type {!proto.compiler.BuildStatus} */ jspb.Message.getFieldWithDefault(this, 2, 0);
};
/**
 * @param {!proto.compiler.BuildStatus} value
 * @return {!proto.compiler.BuildResponse} returns this
 */ proto.compiler.BuildResponse.prototype.setStatus = function(value) {
    return jspb.Message.setProto3EnumField(this, 2, value);
};
/**
 * optional string message = 3;
 * @return {string}
 */ proto.compiler.BuildResponse.prototype.getMessage = function() {
    return /** @type {string} */ jspb.Message.getFieldWithDefault(this, 3, "");
};
/**
 * @param {string} value
 * @return {!proto.compiler.BuildResponse} returns this
 */ proto.compiler.BuildResponse.prototype.setMessage = function(value) {
    return jspb.Message.setField(this, 3, value);
};
/**
 * Clears the field making it undefined.
 * @return {!proto.compiler.BuildResponse} returns this
 */ proto.compiler.BuildResponse.prototype.clearMessage = function() {
    return jspb.Message.setField(this, 3, undefined);
};
/**
 * Returns whether this field is set.
 * @return {boolean}
 */ proto.compiler.BuildResponse.prototype.hasMessage = function() {
 ...
 *     http://goto/soy-param-migration
 * @return {!Object}
 */ proto.compiler.BuildStartEvent.prototype.toObject = function(opt_includeInstance) {
        return proto.compiler.BuildStartEvent.toObject(opt_includeInstance, this);
    };
    /**
 * Static version of the {@see toObject} method.
 * @param {boolean|undefined} includeInstance Deprecated. Whether to include
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.compiler.BuildStartEvent} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */ proto.compiler.BuildStartEvent.toObject = function(includeInstance, msg) {
        var f, obj = {};
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.compiler.BuildStartEvent}
 */ proto.compiler.BuildStartEvent.deserializeBinary = function(bytes) {
    var reader = new jspb.BinaryReader(bytes);
    var msg = new proto.compiler.BuildStartEvent;
    return proto.compiler.BuildStartEvent.deserializeBinaryFromReader(msg, reader);
};
/**
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.compiler.BuildStartEvent} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.compiler.BuildStartEvent}
 */ proto.compiler.BuildStartEvent.deserializeBinaryFromReader = function(msg, reader) {
    while(reader.nextField()){
        if (reader.isEndGroup()) {
            break;
        }
 ...
 * Serializes the message to binary data (in protobuf wire format).
 * @return {!Uint8Array}
 */ proto.compiler.BuildStartEvent.prototype.serializeBinary = function() {
    var writer = new jspb.BinaryWriter();
    proto.compiler.BuildStartEvent.serializeBinaryToWriter(this, writer);
    return writer.getResultBuffer();
};
/**
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.compiler.BuildStartEvent} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */ proto.compiler.BuildStartEvent.serializeBinaryToWriter = function(message, writer) {
    var f = undefined;
};
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
 ...
 *     http://goto/soy-param-migration
 * @return {!Object}
 */ proto.compiler.BuildEndEvent.prototype.toObject = function(opt_includeInstance) {
        return proto.compiler.BuildEndEvent.toObject(opt_includeInstance, this);
    };
    /**
 * Static version of the {@see toObject} method.
 * @param {boolean|undefined} includeInstance Deprecated. Whether to include
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.compiler.BuildEndEvent} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */ proto.compiler.BuildEndEvent.toObject = function(includeInstance, msg) {
        var f, obj = {};
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.compiler.BuildEndEvent}
 */ proto.compiler.BuildEndEvent.deserializeBinary = function(bytes) {
    var reader = new jspb.BinaryReader(bytes);
    var msg = new proto.compiler.BuildEndEvent;
    return proto.compiler.BuildEndEvent.deserializeBinaryFromReader(msg, reader);
};
/**
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.compiler.BuildEndEvent} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.compiler.BuildEndEvent}
 */ proto.compiler.BuildEndEvent.deserializeBinaryFromReader = function(msg, reader) {
    while(reader.nextField()){
        if (reader.isEndGroup()) {
            break;
        }
 ...
 * Serializes the message to binary data (in protobuf wire format).
 * @return {!Uint8Array}
 */ proto.compiler.BuildEndEvent.prototype.serializeBinary = function() {
    var writer = new jspb.BinaryWriter();
    proto.compiler.BuildEndEvent.serializeBinaryToWriter(this, writer);
    return writer.getResultBuffer();
};
/**
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.compiler.BuildEndEvent} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */ proto.compiler.BuildEndEvent.serializeBinaryToWriter = function(message, writer) {
    var f = undefined;
};
/**
 ...
 * @const
 */ proto.compiler.BuildResponseEvent.oneofGroups_ = [
    [
        1,
        2,
        3,
 ...
 */ proto.compiler.BuildResponseEvent.toObject = function(includeInstance, msg) {
        var f, obj = {
            ...
            start: (f = msg.getStart()) && proto.compiler.BuildStartEvent.toObject(includeInstance, f),
            end: (f = msg.getEnd()) && proto.compiler.BuildEndEvent.toObject(includeInstance, f)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
    ...
    while(reader.nextField()){
        ...
        switch(field){
            ...
            case 2:
                ...
                break;
            case 3:
                var value = new proto.compiler.BuildStartEvent;
                reader.readMessage(value, proto.compiler.BuildStartEvent.deserializeBinaryFromReader);
                msg.setStart(value);
                break;
            case 4:
                var value = new proto.compiler.BuildEndEvent;
                reader.readMessage(value, proto.compiler.BuildEndEvent.deserializeBinaryFromReader);
                msg.setEnd(value);
                break;
            default:
                reader.skipField();
 ...
 */ proto.compiler.BuildResponseEvent.serializeBinaryToWriter = function(message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(2, f, proto.compiler.BuildResponse.serializeBinaryToWriter);
    }
    f = message.getStart();
    if (f != null) {
        writer.writeMessage(3, f, proto.compiler.BuildStartEvent.serializeBinaryToWriter);
    }
    f = message.getEnd();
    if (f != null) {
        writer.writeMessage(4, f, proto.compiler.BuildEndEvent.serializeBinaryToWriter);
    }
};
/**
 ...
 */ proto.compiler.BuildResponseEvent.prototype.getResponse = function() {
    return /** @type{?proto.compiler.BuildResponse} */ jspb.Message.getWrapperField(this, proto.compiler.BuildResponse, 2);
};
/**
...
/**
 * optional BuildStartEvent start = 3;
 * @return {?proto.compiler.BuildStartEvent}
 */ proto.compiler.BuildResponseEvent.prototype.getStart = function() {
    return /** @type{?proto.compiler.BuildStartEvent} */ jspb.Message.getWrapperField(this, proto.compiler.BuildStartEvent, 3);
};
/**
 * @param {?proto.compiler.BuildStartEvent|undefined} value
 * @return {!proto.compiler.BuildResponseEvent} returns this
*/ proto.compiler.BuildResponseEvent.prototype.setStart = function(value) {
    return jspb.Message.setOneofWrapperField(this, 3, proto.compiler.BuildResponseEvent.oneofGroups_[0], value);
};
/**
 * Clears the message field making it undefined.
 * @return {!proto.compiler.BuildResponseEvent} returns this
 */ proto.compiler.BuildResponseEvent.prototype.clearStart = function() {
    return this.setStart(undefined);
};
/**
 * Returns whether this field is set.
 * @return {boolean}
 */ proto.compiler.BuildResponseEvent.prototype.hasStart = function() {
    return jspb.Message.getField(this, 3) != null;
};
/**
 * optional BuildEndEvent end = 4;
 * @return {?proto.compiler.BuildEndEvent}
 */ proto.compiler.BuildResponseEvent.prototype.getEnd = function() {
    return /** @type{?proto.compiler.BuildEndEvent} */ jspb.Message.getWrapperField(this, proto.compiler.BuildEndEvent, 4);
};
/**
 * @param {?proto.compiler.BuildEndEvent|undefined} value
 * @return {!proto.compiler.BuildResponseEvent} returns this
*/ proto.compiler.BuildResponseEvent.prototype.setEnd = function(value) {
    return jspb.Message.setOneofWrapperField(this, 4, proto.compiler.BuildResponseEvent.oneofGroups_[0], value);
};
/**
 * Clears the message field making it undefined.
 * @return {!proto.compiler.BuildResponseEvent} returns this

...
#[cfg_attr(feature = "bindings_node", napi(js_name = "avgLosingTrade"))]
#[inline]
pub fn node_avg_losing_trade(gross_loss: f64, losing_trades: i32) -> f64 {
    avg_losing_trade(gross_loss, losing_trades as usize)
}

#[cfg_attr(feature = "bindings_node", napi(js_name = "avgWinLossRatio"))]
#[inline]
...
#[cfg_attr(feature = "bindings_node", napi(js_name = "sharpeRatio"))]
#[inline]
...
#[cfg_attr(feature = "bindings_node", napi(js_name = "sharpeRatioFromReturns"))]
#[inline]
pub fn node_sharpe_ratio_from_returns(returns: &[f64], risk_free_rate: f64) -> f64 {
    sharpe_ratio_from_returns(returns, risk_free_rate)
}

#[cfg_attr(feature = "bindings_node", napi(js_name = "sortinoRatio"))]
#[inline]
...
#[cfg_attr(feature = "bindings_node", napi(js_name = "sortinoRatioFromReturns"))]
#[inline]
...
#[cfg_attr(feature = "bindings_node", napi(js_name = "omegaRatio"))]
#[inline]
...
#[cfg_attr(feature = "bindings_node", napi(js_name = "shortNetProfitPct"))]
#[inline]

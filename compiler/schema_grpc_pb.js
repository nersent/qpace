...
function serialize_compiler_StageEvent(arg) {
  if (!(arg instanceof schema_pb.StageEvent)) {
...
function deserialize_compiler_StageEvent(buffer_arg) {
  return schema_pb.StageEvent.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_compiler_VersionRequest(arg) {
  if (!(arg instanceof schema_pb.VersionRequest)) {
...
function deserialize_compiler_VersionRequest(buffer_arg) {
  return schema_pb.VersionRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_compiler_VersionResponse(arg) {
  if (!(arg instanceof schema_pb.VersionResponse)) {
...
function deserialize_compiler_VersionResponse(buffer_arg) {
  return schema_pb.VersionResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var CompilerApiService = exports.CompilerApiService = {
  version: {
    ...
    requestType: schema_pb.VersionRequest,
    responseType: schema_pb.VersionResponse,
  ...
  build: {
    ...
    responseType: schema_pb.StageEvent,

...
goog.exportSymbol('proto.compiler.BuildStage', null, global);
...
proto.compiler.BuildResponseEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = /** @type {!proto.compiler.BuildStage} */ (reader.readEnum());
      msg.setStage(value);
      break;
    default:
      reader.skipField();
...
proto.compiler.BuildResponseEvent.serializeBinaryToWriter = function(message, writer) {
  ...
  f = /** @type {!proto.compiler.BuildStage} */ (jspb.Message.getField(message, 3));
  if (f != null) {
    writer.writeEnum(
      3,
      f
...
/**
 * optional BuildStage stage = 3;
 * @return {!proto.compiler.BuildStage}
 */
proto.compiler.BuildResponseEvent.prototype.getStage = function() {
  return /** @type {!proto.compiler.BuildStage} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/**
 * @param {!proto.compiler.BuildStage} value
 * @return {!proto.compiler.BuildResponseEvent} returns this
 */
proto.compiler.BuildResponseEvent.prototype.setStage = function(value) {
  return jspb.Message.setOneofField(this, 3, proto.compiler.BuildResponseEvent.oneofGroups_[0], value);
};
 ...
 * @return {!proto.compiler.BuildResponseEvent} returns this
 */
proto.compiler.BuildResponseEvent.prototype.clearStage = function() {
  return jspb.Message.setOneofField(this, 3, proto.compiler.BuildResponseEvent.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.compiler.BuildResponseEvent.prototype.hasStage = function() {
  return jspb.Message.getField(this, 3) != null;
};

 ...
 * @const
 */
proto.compiler.BuildResponseEvent.oneofGroups_ = [[1,2,3,4]];
...
proto.compiler.BuildResponseEvent.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.compiler.BuildStartEvent.serializeBinaryToWriter
    );
  }
  f = message.getEnd();
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto.compiler.BuildEndEvent.serializeBinaryToWriter
    );
  }
};
...
proto.compiler.BuildResponseEvent.prototype.getStart = function() {
  return /** @type{?proto.compiler.BuildStartEvent} */ (
    jspb.Message.getWrapperField(this, proto.compiler.BuildStartEvent, 3));
};
...
proto.compiler.BuildResponseEvent.prototype.getEnd = function() {
  return /** @type{?proto.compiler.BuildEndEvent} */ (
    jspb.Message.getWrapperField(this, proto.compiler.BuildEndEvent, 4));
};

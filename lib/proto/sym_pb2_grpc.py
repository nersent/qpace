...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in sym_pb2_grpc.py depends on'
...
def add_SymApiServicer_to_server(servicer, server):
    rpc_method_handlers = {

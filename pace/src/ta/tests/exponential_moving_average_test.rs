...
mod tests {
    ...
    fn format_path(path: &str) -> PathBuf {
        format_pace_fixture_path(&format!("tests/ta/ema/{}", path))
    }

    fn _test(target: &mut Ema, expected: &[f64]) {
